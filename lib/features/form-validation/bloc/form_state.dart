...
/// Only need one state for validation (excluding initial one).
/// We need the Equatable package which overrides both === and the internal
/// hashcode which saves us time. We use [props] to add all the fields.
/// Whenever one field changes, we have a state change.
